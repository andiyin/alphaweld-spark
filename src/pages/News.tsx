...
const News = () => {
  ...
  const categories = ["Alle", "Produktnews", "Events", "Unternehmen", "Bildung", "Digital"];
        ...
        <section className="bg-gradient-secondary text-white py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">News & Aktuelles</h1>
              <p className="text-xl text-white/90">
                Bleiben Sie auf dem Laufenden über Produktneuheiten, Events und Unternehmensnews
              </p>
            </div>
          </div>
        </section>
