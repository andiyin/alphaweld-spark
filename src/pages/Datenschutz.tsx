    ...
    <Layout>
      <div className="min-h-screen bg-background">
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Erhebung und Speicherung personenbezogener Daten sowie Art und Zweck von deren Verwendung</h2>
              
              {/* Website Visit */}
              <Card className="shadow-elegant mb-8">
                <CardHeader>
                  <CardTitle>Beim Besuch der Website</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">
              ...
              <Card className="shadow-elegant mb-8">
                <CardHeader>
                  <CardTitle>Bei Nutzung unseres Kontaktformulars</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Weitergabe von Daten</h2>
              <Card className="shadow-elegant mb-8">
                <CardContent>
                  <p className="mb-4">
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Cookies</h2>
              <Card className="shadow-elegant mb-8">
                <CardContent>
                  <p className="mb-4">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Analyse-Tools</h2>
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Betroffenenrechte</h2>
              <Card className="shadow-elegant mb-8">
                <CardContent>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Datensicherheit</h2>
              <Card className="shadow-elegant mb-8">
                <CardContent>
                  <p className="mb-4">
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Datenschutz bei Bewerbungen und im Bewerbungsverfahren</h2>
              <Card className="shadow-elegant mb-8">
                <CardContent>
                  <p className="mb-4">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8">Aktualität und Änderung dieser Datenschutzerklärung</h2>
              <Card className="shadow-elegant mb-8">
                <CardContent>
                  <div className="flex items-center gap-3 mb-4">
                    <Calendar className="h-6 w-6 text-primary" />
                    <p className="font-semibold">Stand: Mai 2018</p>
                  </div>
                  <p>
